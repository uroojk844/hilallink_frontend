  ...
  return (
    <div className='glass fixed inset-0 grid place-items-center z-50'>
        <div className='animate__animated animate__bounceIn bg-white w-[min(400px,95%)] rounded-md shadow-lg overflow-hidden'>
              <div className='font-bold text-lg p-4 border-b flex items-center gap-3'><BsArrowLeft className='cursor-pointer'onClick={()=>switchAc(false)}/> Switch account</div>
              <section className='py-3'>
                  <div className='flex items-center gap-3 hover:bg-gray-100 pointer-cursor cursor-pointer p-3'>
                      <img src="https://picsum.photos/400" className='h-12 w-12 object-contain rounded-full' alt="" />
                      <div>
                  ...
                  <div className='flex items-center gap-3 hover:bg-gray-100 pointer-cursor cursor-pointer p-3'>
                      <img src="https://picsum.photos/400?2" className='h-12 w-12 object-contain rounded-full' alt="" />
                      <div>
                  ...
                  <div className='flex items-center gap-3 hover:bg-gray-100 pointer-cursor cursor-pointer p-3'>
                      <img src="https://picsum.photos/400?3" className='h-12 w-12 object-contain rounded-full' alt="" />
                      <div>
