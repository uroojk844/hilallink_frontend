          ...
          <div className="flex items-center justify-center w-full relative">
            ...
            >
              <div className="flex flex-col  items-center justify-center pt-5 pb-6">
                <svg
                  className="w-8 h-8 mb-4 text-gray-500 dark:text-[#afa99e] dark:text-gray-400"
                  aria-hidden="true"
                ...
                <p className="mb-2 text-sm text-gray-500 dark:text-[#afa99e] dark:text-gray-400">
                  <span class="font-semibold">Click to upload</span> or drag and
                  drop
                </p>
                <p className="text-xs text-gray-500 dark:text-[#afa99e] dark:text-gray-400">
