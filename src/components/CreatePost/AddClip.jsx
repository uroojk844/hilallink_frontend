    ...
    <div>
      ...
      {video ? (
        <div className="relative w-[36%] max-sm:w-[52%] overflow-hidden mb-4 rounded-md h-[320px] bg-black mx-auto ">
          <BsFillXCircleFill className="text-white text-lg cursor-pointer absolute left-1 top-1 z-50" onClick={()=>setVideo("")}/>
          <video src={URL.createObjectURL(video)} controls className="h-full w-full object-contain"></video>
        </div>
      ) : (
